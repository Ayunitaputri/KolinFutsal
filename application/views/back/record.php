  ...
  <div class="row">
    <div class='col-lg-4'>
      <div class='small-box bg-teal'>
        <div class='inner'><h3> Rp <?php echo number_format(floatval($omset_harian)) ?> </h3><p><b>OMSET HARI INI</b></p></div>
    ...
    <div class='col-lg-4'>
      <div class='small-box bg-teal'>
        <div class='inner'><h3> Rp <?php echo number_format(floatval($omset_bulanan)) ?> </h3><p><b>OMSET BULAN INI</b></p></div>
        <div class='icon'><i class='fa fa-money'></i></div>
        <a href='<?php echo base_url('admin/transaksi') ?>' class='small-box-footer'>Selengkapnya <i class='fa fa-arrow-circle-right'></i></a>
      </div>
    </div>
    <div class='col-lg-4'>
      <div class='small-box bg-teal'>
        <div class='inner'><h3> Rp <?php echo number_format(floatval($omset_tahunan)) ?> </h3><p><b>OMSET TAHUN INI</b></p></div>
        <div class='icon'><i class='fa fa-money'></i></div>
        <a href='<?php echo base_url('admin/transaksi') ?>' class='small-box-footer'>Selengkapnya <i class='fa fa-arrow-circle-right'></i></a>
      </div>
    </div>
